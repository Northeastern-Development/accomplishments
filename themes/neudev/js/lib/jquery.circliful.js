        ...
        return this.each(function () {
            ...
            if (settings.halfCircle) {
                ...
                circleContainer
                    ...
                    .append(
                        $('<svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 194 186" class="circliful" preserveAspectRatio="xMidYMin">' +
            ...
            function drawCircles() {
                if (settings.multiPercentage === 1) {
                    ...
                    circleContainer
                        .addClass('svg-container')
                        .append(
                            $('<svg xmlns="http://www.w3.org/2000/svg" version="1.1" height="100%" viewBox="0 0 194 186" class="circliful" preserveAspectRatio="xMidYMin">' +
                                (typeof elements !== 'undefined' ? elements : '') +
