				...
				<section>
					...
					<div class="nu__full-container">
						...
						<div class="nu__fixed-column" style="background: url(<?php echo get_stylesheet_directory_uri(); ?>/img/alumni/global_network_lifelong_connections_bg.png); background-size: cover; background-position: center center;">
							<div>
								<p><a class="js-back-page" href="<?=home_url()?>/pride-and-support"><i class="fa fa-angle-double-left" aria-hidden="true"></i> Back</a></p>
						...
						<div class="nu__scroll-column">
							<div>
								...
								<a class="js-back-page nu__mobile-back" href="<?=home_url()?>/pride-and-support"><i class="fa fa-angle-double-left" aria-hidden="true"></i> Back</a>
							</div>
