						...
						<div class="nu__scroll-column">
							<div>
								...
								<article>
									...
									<p>Keith Corso, DMSB'21, and Evan Eddleston, DMSB'22, created BusRight, a new app that keeps track of school bus passengers, pinpoints locations of buses in transit, and calculates optimal routes. BusRight won $40,000 at the national undergraduate business pitch competition, E&ndash;Fest, and the entrepreneurs believe they can revolutionize the school bus industry. "Bus drivers are home earlier, students are home earlier, and parents know where their kids are. It's a much more efficient system than the one in place today," says Eddleston.</p>
								</article>
								...
								<article>
									...
									<p>Raymond Fu&mdash;who holds joint appointments in the College of Engineering and the College of Computer and Information Science&mdash;is the founder of a startup, Giaran, that uses AI to allow consumers to test cosmetics products virtually. The company's technology leverages research that uses computer vision, Big Data, and augmented reality to create novel algorithms for data mining and predictive modeling. </p>
								</article>
								...
								<article>
									...
									<!-- <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/entrepreneurs/candy_pieces.jpg" alt="pieces of candy"> -->
									<p>Doctoral student Solomon Mensah co&ndash;founded Therapeutic Innovations in 2014 with the goal of designing cheaper, easier&ndash;to&ndash;use medical devices for developing countries. The company’s prototype, called the Airbaby, features a face mask that delivers a combination of ambient air and oxygen to babies to help their lungs function and retain oxygen. Therapeutic Innovations was accepted into MassChallenge in 2016 and received a $50,000 grant from the National Science Foundation’s I&ndash;CORPS program in 2017.</p>
								</article>
