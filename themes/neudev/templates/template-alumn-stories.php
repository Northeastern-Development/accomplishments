					...
					<div class="nu__full-container">
						...
						<div class="nu__fixed-column" style="background: url(<?php echo get_stylesheet_directory_uri(); ?>/img/alumni/global_network_lifelong_connections_bg.png); background-size: cover; background-position: center center;">
							<div>
								...
								<img  src="<?php echo get_stylesheet_directory_uri(); ?>/img/empower/p-and-s-mosaic.png" alt="global network lifelong connections">
							</div>
						...
						<div class="nu__scroll-column">
							<div>
								...
								<article>
									<figure>
										<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/alumni/faust.jpg" alt="Faust and Marciano">
										<!-- <figcaption>Photo courtesy of Dan Concessi. Photo courtesy of Matt Flannery</figcaption> -->
									</figure>
									<p>After working as a freelance sports broadcaster and the voice of Northeastern men's basketball for five years, Alex Faust, SSH'12, got his big break in 2017, when he called his first National Hockey League game. Today, as the LA Kings play&ndash;by&ndash;play announcer for Fox Sports West, he is the NHL's youngest announcer. A former member of the Young Alumni Advisory Board, a group of alumni who support alumni programming, Faust is always keen to come back to his alma mater. He hosted alumnus&ndash;actor David Marciano, AS'83, at an Office of Alumni Relations' Northeastern Near You event in California in 2017. And in August, he joined the Coaches Caravan on Cape Cod to celebrate the record&ndash;breaking success of the Howlin' Huskies.</p>
								</article>
								...
								<article>
									...
									<p>Whitney Pray's deep dive into anthropology at Northeastern inspired a deep curiosity about other cultures. It also nudged her to move beyond her comfort zone. In 2011, Pray, SSH'13, traveled to Colombia to teach English and fell in love with the country. Venturing into business in Bogotá, she opened an artisan shop that became a restaurant and, in 2018, a bakery called El Nido (The Nest). Pray hopes to build a community for sharing knowledge and experience, starting with her own Northeastern network. This fall, she will host the Office of Alumni Relations' first Huskies Hands&ndash;On program in Bogotá.</p>
								</article>
								...
								<article>
									...
									<p>People who know Legacy Husky Sydney Stewart, AMD'15, call her a born leader. As an undergraduate studying communications and cinema studies, Stewart joined the Iota Gamma chapter of Alpha Kappa Alpha Sorority, which her mother, alumna Ann W. Stewart, SH'76, started at Northeastern in 1974. Sydney also served on the National Pan&ndash;Hellenic Council, bringing together representatives from nine African American fraternities and sororities, and was named to the Huntington 100. Today she serves on the Office of Alumni Relations' Young Alumni Advisory Board, working to engage and empower recent graduates. Committed to black alumni engagement, in 2018, she co&ndash;chaired Black Alumni Weekend on Martha's Vineyard.</p>
								</article>
