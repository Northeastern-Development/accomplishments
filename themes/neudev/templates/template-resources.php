					...
					<div class="nu__scroll-column">
						<div>
							...
							<article>
								...
								<p>The course "demands systems thinking on a global level," a skill SAIL aims to nurture. Students must balance environmental and health impacts against variables such as cost and materials choices&mdash;options that come with their own ramifications.</p>
								...
								<p>"Learning to self&ndash;reflect, students discover their preferences … and how to learn what they don't know."</p>
							</article>
							...
							<article>
							 ...
							 <p>You’ll seek others' advice about co&ndash;ops that interest you, Andolena says. And while you're on co&ndash;op, when "it can be hard to feel connected," you'll search for events that bring co&ndash;op students together.</p>
							...
							<article>
								...
								<p>From her long experience managing international human&ndash;service programs, Riccio also understands the importance of skills SAIL teaches, like perspective taking and cultural agility. Today she empowers students to think, work, and collaborate across sectors and disciplines to benefit their communities.</p>
								<p>As students learn to effect change through philanthropy, awarding grants to nonprofits, they describe their insights in terms of SAIL's five dimensions. Assignments and readings explicitly invite them to hone skills like negotiating, and traits like respect and civic&ndash;mindedness.</p>
								...
								<p>SAIL also "holds me accountable," she says, to giving students not just knowledge, but the "experiences and reflection time" they'll need to persevere as citizen&ndash;leaders and change agents fighting for social and economic justice, a sustainable planet, and the well&ndash;being of all.</p>
							...
							<article>
								...
								<p>SAIL's earliest adopters are students in Northeastern's Explore program: first&ndash;years who haven't chosen a major. For them, "SAIL comes naturally," says director Kim Irmiter.</p>
								<p>Like Explore, SAIL is all about developing along dimensions&mdash;like personal and professional growth&mdash;that are fundamental to students' identity and focus. "Our students are already charting not only their academic path, but also experiential opportunities and co&ndash;curriculars."</p>
								...
								<p>Using the SAIL app, they share their 360 "honeycomb" visualization and "moments," insights relevant to their academic and career explorations. They write about setbacks and successes in clubs, sports, and other activities that build attributes like self&ndash;advocacy and leadership.</p>
							...
							<article>
								...
								<p>Today, as co&ndash;founders of Aweik, these alumni are promoting social entrepreneurship in Latin America to solve stubborn problems in education, health, and other areas, thanks to what they say is their exponential growth in one of SAIL's learning dimensions: social consciousness and commitment.</p>
								<p>Through student orientation, advising, and the co&ndash;op course, "We got to know ourselves better, explore our interests, and look for the experiences we needed," says Alejandra, a combined business and economics major. Next came the Global Social Enterprise course, a Dialogue of Civilizations in India to explore the roots of poverty, and co&ndash;ops&mdash;Alejandra at a microfinance nonprofit in San Francisco, and Vanessa at a technology&ndash;based startup in New York.</p>
								<p>Integrating lessons learned, Aweik supports technology&ndash;focused social entrepreneurs, connecting them to business leaders and policymakers worldwide. This fall, Aweik will host an impact development summit in Ecuador.</p>
