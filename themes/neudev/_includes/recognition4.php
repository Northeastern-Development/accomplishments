<div class="content-lists" style="width:100%;margin:0;float:none;">
  <div class="talkingheadss">

    <div class="theheadss">
      <div data-id="talkingheads-1" class="talkingheads" style="background: url(/wp-content/themes/neudev/img/research/neu_m043cb924.jpg); background-size: cover; background-position: center center;" title="Click here to learn more about Lisa Feldman-Barrett"><span></span></div>
      <div data-id="talkingheads-2" style="background: url(/wp-content/themes/neudev/img/research/neu_m040d735n-master.jpg); background-size: cover; background-position: center center;" title="Click here to learn more about Albert-László Barabási "><span></span></div>
      <div data-id="talkingheads-3" style="background: url(/wp-content/themes/neudev/img/research/neu_m042wg56j.jpg); background-size: cover; background-position: center center;" title="Click here to learn more about Theo Davis"><span></span></div>
      <div data-id="talkingheads-4" style="background: url(/wp-content/themes/neudev/img/research/neu_m042n9968.jpg); background-size: cover; background-position: center center;" title="Click here to learn more about Jessica Silbey"><span></span></div>
      <div data-id="talkingheads-5" style="background: url(/wp-content/themes/neudev/img/research/neu_m042c118v.jpg); background-size: cover; background-position: center center;" title="Click here to learn more about Miriam Leeser"><span></span></div>
    </div>

    <div class="chooseatalkingheads">
      <div class="prev" title="Click here to jump to the previous item">&lsaquo;</div>
      <div>
        <div id="talkingheads-1">
        ...
        <div id="talkingheads-4">
          <div class="talkingheads-img" style="background: url(/wp-content/themes/neudev/img/research/neu_m042n9968.jpg); background-size: cover; background-position: center center;">
          </div>
          <div class="talkingheads-content">
