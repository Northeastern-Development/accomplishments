...
function nudev_nav()
{
	...
	array(
		...
		'depth'           => 0,
		'walker'          => new neo_walker_nav_menu()
		)
	);
}

// Extend Walker Menu
class neo_walker_nav_menu extends Walker_Nav_Menu {
...
wp_enqueue_style( 'wpb-google-fonts', 'https://fonts.googleapis.com/css?family=Lato:300,400,700,900', false );
  ...
  if ( is_page( '5' ) ) {//home
    wp_register_script('radial', get_template_directory_uri() . '/js/lib/jquery.circliful.js', array('jquery'), '1.1.0', true); // Custom scripts
    wp_enqueue_script('radial'); // Enqueue it!
  }

  if(is_page([23,26,29,76])) { //learning, research, empower
    wp_register_script('magnific', get_template_directory_uri() . '/js/lib/magnific-popup-min.js', array('jquery'), '1.1.0', true); // Custom scripts
    wp_enqueue_script('magnific'); // Enqueue it!
  }

  if(is_page([5,23,26,29,76])) { //home, learning, research, empower
    wp_register_script('waypoints', get_template_directory_uri() . '/js/lib/jquery.waypoints-min.js', array('jquery'), '4.0.1', true); // Custom scripts
    wp_enqueue_script('waypoints'); // Enqueue it!
  }

  if(is_page([5,23,26,29,76])) { //home, learning, research, empower
    wp_register_script('inview', get_template_directory_uri() . '/js/lib/inview-min.js', array('jquery'), '4.0.1', true); // Custom scripts
    wp_enqueue_script('inview'); // Enqueue it!
  }

  if ( is_page( '26' ) ) {//learning
    wp_register_script('velocity', get_template_directory_uri() . '/js/lib/velocity.js', array('jquery'), '1.0.0', true); // Custom scripts
    wp_enqueue_script('velocity'); // Enqueue it!
  }

  wp_register_script('nudevscripts', get_template_directory_uri() . '/js/main-min.js', array('jquery'), '1.0.0'); // Custom scripts
...
function nudev_styles(){
    ...
    wp_register_style('fontawesome', get_template_directory_uri() . '/styles/css/plugin/font-awesome.min.css', array(), '4.7', 'all');
    wp_enqueue_style('fontawesome'); // Enqueue it!

    if(is_page([23,26,29,76])) { //learning, research, empower
      wp_register_style('magnificpopup', get_template_directory_uri() . '/styles/css/plugin/magnific.css', array(), '4.7', 'all');
    ...
    // }
    //
    // if ( is_page( '29' ) ) {//empower
    //   wp_register_style('magnificpopup', get_template_directory_uri() . '/styles/css/plugin/magnific.css', array(), '4.7', 'all');
    //   wp_enqueue_style('magnificpopup'); // Enqueue it!
    // }


    wp_register_style('nudevmainstyle', get_template_directory_uri() . '/styles/css/main.css', array(), '1.0', 'all');
    wp_enqueue_style('nudevmainstyle'); // Enqueue it!

    // if ( is_page( '5' ) ) {//homepage
    //   wp_register_style('homestyle', get_template_directory_uri() . '/styles/css/home.css', array(), '1.0', 'all');
    //   wp_enqueue_style('homestyle'); // Enqueue it!
    // }

    if ( is_page( '23' ) ) {//learning
      wp_register_style('learningstyle', get_template_directory_uri() . '/styles/css/learning.css', array(), '1.0', 'all');
    ...
    // if ( is_page( '29' ) ) {//empower
    //   wp_register_style('empowerstyle', get_template_directory_uri() . '/styles/css/empower.css', array(), '1.0', 'all');
    //   wp_enqueue_style('empowerstyle'); // Enqueue it!
    // }

    if ( is_page( '76' ) ) {//empower
      wp_register_style('empowerstyle', get_template_directory_uri() . '/styles/css/empower.css', array(), '1.0', 'all');
      wp_enqueue_style('empowerstyle'); // Enqueue it!
    }
    ...
    if ( is_page( '42' ) ) {//entrepreneurs
      wp_register_style('entrepreneursstyle', get_template_directory_uri() . '/styles/css/entrepreneurs.css', array(), '1.0', 'all');
      wp_enqueue_style('entrepreneursstyle'); // Enqueue it!
    }

    if ( is_page( '45' ) ) {//mclarney
      wp_register_style('mclarneystyle', get_template_directory_uri() . '/styles/css/mclarney.css', array(), '1.0', 'all');
      wp_enqueue_style('mclarneystyle'); // Enqueue it!
    }

    if ( is_page( '48' ) ) {//titcomb
      wp_register_style('titcombstyle', get_template_directory_uri() . '/styles/css/titcomb.css', array(), '1.0', 'all');
...
function neudev_include_custom_jquery() {
	...
	wp_enqueue_script('jquery', 'https://ajax.googleapis.com/ajax/libs/jquery/2.2.0/jquery.min.js', array(), true, '2.2.0', false);
...
if (function_exists('register_sidebar'))
{
    ...
    register_sidebar(array(
        'name' => __('Sidebar Widgets', 'nudev'),
        'description' => __('Widgets on the sidebar...', 'nudev'),
        'id' => 'widget-area-1',
...
function nudev_view_article($more)
{
    global $post;
...
add_filter('excerpt_more', 'nudev_view_article'); // Add 'View Article' button instead of [...] for Excerpts
...
function create_post_type_nudev()
{
    ...
    register_post_type('nudev', // Register Custom Post Type
        array(
        'labels' => array(
            'name' => __('nudev Custom Post', 'nudev'), // Rename these to suit
            'singular_name' => __('nudev Custom Post', 'nudev'),
            'add_new' => __('Add New', 'nudev'),
            'add_new_item' => __('Add New nudev Custom Post', 'nudev'),
            'edit' => __('Edit', 'nudev'),
            'edit_item' => __('Edit nudev Custom Post', 'nudev'),
            'new_item' => __('New nudev Custom Post', 'nudev'),
            'view' => __('View nudev Custom Post', 'nudev'),
            'view_item' => __('View nudev Custom Post', 'nudev'),
            'search_items' => __('Search nudev Custom Post', 'nudev'),
            'not_found' => __('No nudev Custom Posts found', 'nudev'),
            'not_found_in_trash' => __('No nudev Custom Posts found in Trash', 'nudev')
        ),
        'public' => true,
